...
require.register("horwheel/index.js", function (exports, require, module) {
    ...
    function horizontalWheel(event, el) {
    ...
    function verticalWheel(eve, el) {
        el = document.getElementById('body');
        el.scrollTop += (!eve.deltaY) ? eve.deltaY : (!eve.detail && eve.detail !== 0) ? eve.detail : -eve.wheelDelta;
    }
    /**
     * horwheel
     */
    function horwheel(el) {
        ...
        el[bind](wheel, function (event) {
            event = event || window.event;
            if (event.preventDefault) {
                event.preventDefault();
            }
            if (event.clientX < 473) {
                verticalWheel(event, el);
            }
            else {
                horizontalWheel(event, el);
            }
            return false;
        }, false);
    }
